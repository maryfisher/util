package maryfisher.debug {
	...
	public class Stats extends Sprite {
		 ...
		 * respectively.
		 */
		public function Stats(minimized:Boolean = false, transparent:Boolean = false, meanDataLength:uint = 0, enableClickToReset:Boolean = true, enableModifyFrameRate:Boolean = true) {
			super();
